...
def test_shifting():
    ...
    assert x10.distance(origin) == 10
    assert y10.distance(origin) == 10
    assert x10.distance(x10y10) == 10
    assert y10.distance(x10y10) == 10
    assert x10y10.distance(origin) == 10 * 2 ** 0.5
