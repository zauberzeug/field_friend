...
class PlantProvider:
    def __init__(self) -> None:
        ...
        self.WEEDS_CHANGED = rosys.event.Event()
        '''The list of weeds has changed'''
        self.CROPS_CHANGED = rosys.event.Event()
        '''The list of crops has changed'''
