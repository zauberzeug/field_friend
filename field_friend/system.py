...
from .swam_connection import SwarmConnection
...
class System(rosys.persistence.PersistentModule):
    ...
    def __init__(self) -> None:
        ...
        if self.is_real and os.environ.get('SWARM_URL'):
            ...
            swarm_passphrase = os.environ.get('SWARM_PASSPHRASE')
            assert swarm_url is not None
            self.swarm_connection = SwarmConnection(self, swarm_url, swarm_passphrase)
