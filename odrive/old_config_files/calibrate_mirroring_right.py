...
assert_equal(odrv0.axis0.config.can.node_id, 0x100 >> 5)
...
print('- Mirroring configuration')
assert_equal(odrv0.axis1.controller.config.input_mode, enums.INPUT_MODE_MIRROR)
assert_equal(odrv0.axis1.controller.config.axis_to_mirror, 0)
assert_equal(odrv0.axis1.controller.config.mirror_ratio, 1.0)  # 1:1 mirroring
